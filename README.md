# TimingTock_Demo-for-learning-purposes
Flutter + ASP.NET Core Minimal API 学习 demo，实现登录注册及数据同步，计时功能仅雏形

A simple cross-platform demo app built with **Flutter** (frontend) and **ASP.NET Core Minimal API** (backend).  
