      ...
      body: Container(
        ...
        child: Column(
          children: [
            SizedBox(height: 100,),
            getAnimatedWidget(
                child: Text("TimingTocK",style: TextStyle(fontSize: 40,fontWeight: FontWeight.bold,fontFamily: "Customfont"),),
            ...
            getAnimatedWidget(
                child: Row(
                  ...
                  children: [
                    Text("账号：",style: TextStyle(fontSize: 20,fontFamily: "Customfont"),),
                    Container(
            ...
            getAnimatedWidget(
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Text("密码：",style: TextStyle(fontSize: 20,fontFamily: "Customfont"),),
                    Container(
                      clipBehavior: Clip.antiAlias,
                      decoration: ShapeDecoration(
                          color: Colors.white,
            ...
            getAnimatedWidget(
                child: LogButton(
                    onTap: (){
                      if(textEditingController.text.isEmpty||textEditingController1.text.isEmpty){
                        showDialog(context: context, builder: (bc){
                          return AlertDialog(
                            ...
                            content: SizedBox(
                              ...
                              height: 50,
                              child: Center(
                                child: Text("账号或密码不能为空",style: TextStyle(fontSize: 20,fontFamily: "CustomFont"),),
                              ),
                            ),
                          );
                        });
                      }else{
                        var future= FlutterData.TrySignIn(textEditingController.text,textEditingController1.text);
  ...
  Widget getAnimatedWidget({
    ...
    return FadeTransition(
      ...
      child: SlideTransition(
        position: Tween<Offset>(begin: const Offset(2.0, 0.0), end: Offset.zero).animate(
          CurvedAnimation(
            parent: animationController,
            curve: interval,
          ),
